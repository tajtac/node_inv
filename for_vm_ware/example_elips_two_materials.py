...
with open('params_for_cluster_inhomogenous_prob.npy', 'rb') as f:
...
with open('ellipse_2models_pre.npy', 'wb') as f:
...
#%%    
with open('ellipse_2models_pre.npy', 'rb') as f:
...
Lambda_params, val_loss, metrics = train_colloc(loss, [mesh_points, t_hist], get_params, opt_update, opt_state, 
                                            key, sharding, 'cross', nIter = 20000, print_freq=100, batch_size=1000)
#%%
# Train
a1 = 10000
@jit
...
Lambda_params, val_loss, metrics = train_colloc(loss, [mesh_points, t_hist], get_params, opt_update, opt_state, 
                                            key, sharding, 'cross', nIter = 50000, print_freq=1000, batch_size=1000)

with open('O_2models_post.npy', 'wb') as f:
