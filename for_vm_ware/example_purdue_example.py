...
with open('params_for_cluster_purdue_prob.npy', 'rb') as f:
...
with open('purdue_pre.npy', 'wb') as f:
...
#%%    
with open('purdue_pre.npy', 'rb') as f:
...
with open('purdue_second_pretraining.pickle', 'wb') as f:
