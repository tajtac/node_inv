...
with open('params_for_cluster_ring_biaxial_noisless_prob.npy', 'rb') as f:
...
with open('ring_biaxial_noisless_pre.npy', 'wb') as f:
...
#%%    
with open('ring_biaxial_noisless_pre.npy', 'rb') as f:
...
with open('ring_biaxial_noisless_second_pretraining.pickle', 'wb') as f:
...
with open('ring_biaxial_noisless_post.npy', 'wb') as f:
    pickle.dump([elem_X, strains, Force_x, Force_y, node_params, Lambda_params, val_loss, metrics, t_hist, lmb_hist], f)
with open('ring_biaxial_noisless_main_training.pickle', 'wb') as f:
    pickle.dump([val_loss, metrics], f)
print('it worked')
