...
with open('params_for_cluster_ring_biaxial_noisy_3_biaxial_tests_prob.npy', 'rb') as f:
...
with open('ring_biaxial_noisy_3_biaxial_tests_prob_pre.npy', 'wb') as f:
...
#%%    
with open('ring_biaxial_noisy_3_biaxial_tests_prob_pre.npy', 'rb') as f:
...
with open('ring_biaxial_noisy_3_biaxial_tests_second_pretraining.pickle', 'wb') as f:
...
with open('ring_biaxial_noisy_3_biaxial_tests_prob_post.npy', 'wb') as f:
    pickle.dump([elem_X, strains, Force_x, Force_y, node_params, Lambda_params, val_loss, metrics, t_hist, lmb_hist], f)
with open('ring_biaxial_noisy_3_biaxial_tests_main_training.pickle', 'wb') as f:
    pickle.dump([val_loss, metrics], f)
print('it worked')
