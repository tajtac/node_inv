...
class TestWideToLong:
    ...
    def test_col_substring_of_stubname(self):
        ...
        expected = wide_to_long(wide_df, stubnames=["PA"], i=["node_inv", "A"], j="time")
        result = wide_to_long(wide_df, stubnames="PA", i=["node_inv", "A"], j="time")
        tm.assert_frame_equal(result, expected)
